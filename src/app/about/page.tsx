                    ...
                    <div className="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                      ...
                      <div className="px-6 pb-14 pt-6 text-white">
                        ...
                        <pre className="text-sm leading-6 text-gray-300">
                          ...
                          <div>{`  <Timeline events={lifeEvents} />`}</div>
...
const values = [
  {
    ...
    icon: 'heart',
    description:
      'We approach every memorial with the utmost respect, understanding the sensitivity of honoring a loved one\'s memory.',
  },
  {
    name: 'Quality and Care',
    icon: 'check',
    description:
      'We\'re committed to creating beautiful, high-quality memorials that truly capture the essence of a person\'s life and legacy.',
  },
  {
    name: 'Privacy and Security',
    icon: 'settings',
    description:
      'We protect your memories with robust privacy controls and security measures, ensuring you have complete control over who can view and contribute.',
  },
  {
    name: 'Accessibility',
    icon: 'users',
    description:
      'We believe that memorials should be accessible to all, regardless of technical ability or physical location.',
  },
  {
    name: 'Innovation',
    icon: 'image',
    description:
      'We continuously strive to enhance our platform with thoughtful features that help preserve and share memories in meaningful ways.',
  },
  {
    name: 'Community',
    icon: 'share',
    description:
      'We foster a supportive community where families and friends can connect, share memories, and find comfort in preserving the legacy of their loved ones.',
  },
];
...
const team = [
  {
    ...
    role: 'Founder & CEO',
    bio: 'After losing his grandmother, Michael created Memory Vista to help families preserve memories in a beautiful digital format.',
  },
  {
    name: 'Sarah Chen',
    role: 'Chief Design Officer',
    bio: 'Sarah brings her background in UX design to create memorial experiences that are both beautiful and emotionally resonant.',
  },
  {
    name: 'David Rodriguez',
    role: 'CTO',
    bio: 'David leads our technical team, ensuring the platform is secure, accessible, and easy to use for everyone.',
  },
  {
    name: 'Amara Wilson',
    role: 'Customer Success',
    bio: 'Amara works directly with families to help them create meaningful memorials during difficult times.',
  },
]; 